...
const Auth = () => {
  ...
  return (
    <div className='h-screen flex justify-center items-center flex-col'>
          <div className="max-w-lg flex flex-col items-center justify-center text-2xl font-bold text-gray-700"> 
            ...
            <p className="font-normal text-[13px] tracking-tight">Already have an account? <span className="text-blue-500 font-semibold cursor-pointer" onClick={()=> navigate('/signin')}>signin</span> </p>
            </div>
  ...
  <form onSubmit={handleSubmit} className="max-w-lg flex flex-col justify-start mt-1 md:justify-center">
    ...
    <label htmlFor="email" className="font-medium text-gray-600 mt-1 mb-1">Email</label>
    <input
    type="email"
    id="email"
    ...
    <button type="submit" className="bg-sky-500 text-white px-[113px] py-2 rounded-lg font-semibold border  mt-5" > signup </button>

    <button className="text-slate-600 px-[85px] items-center flex py-2 rounded-lg border font-semibold tracking-tighter mt-5" > signup with <FcGoogle className="ml-1"/>  </button>
</form>
